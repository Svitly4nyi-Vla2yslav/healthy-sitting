...
`;const k=()=>{const{t:a}=p();return c.useEffect(()=>{x.init({duration:3e3})},[]),t.jsxs("div",{id:"/home",style:{marginTop:76},children:[t.jsx(b,{style:{width:"100%"},children:t.jsxs("video",{autoPlay:!0,loop:!0,muted:!0,style:{},children:[t.jsx("source",{src:m,type:"video/mp4"}),"Your browser does not support the video tag."]})}),t.jsxs(g,{children:[t.jsx(w,{children:a("Background.slide1Text")}),t.jsx(j,{children:t.jsx(f,{to:"video",smooth:!0,duration:1e3,children:t.jsx(v,{children:t.jsx(z,{children:t.jsx(r,{style:{fontSize:50}})})})})})]})]})};export{k as default};
